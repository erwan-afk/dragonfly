...
CREATE SEQUENCE IF NOT EXISTS "public"."boats_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE "public"."boats_id_seq" OWNER TO "postgres";
...
CREATE INDEX "boats_user_id_idx" ON "public"."boats" USING "btree" ("user_id");



CREATE INDEX "payments_boat_id_idx" ON "public"."payments" USING "btree" ("boat_id");
...
ALTER TABLE ONLY "public"."boats"
    ADD CONSTRAINT "boats_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE CASCADE;
...
GRANT ALL ON SEQUENCE "public"."boats_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."boats_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."boats_id_seq" TO "service_role";
